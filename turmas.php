...
function listarTurmas() {
    ...
    try {
        ...
        // 4. A consulta final agora seleciona as colunas corretas
        $sql = "SELECT t.*, e.status as status_ensalamento " . $sql_base . " WHERE " . implode(' AND ', $where) . " ORDER BY t.codigo LIMIT " . $limite . " OFFSET " . $offset;
